...
The MCP server talks to the same REST API as the web UI (Corporate UI v1.7.57+, shopping guards v1.7.59+, Gemini usage guards v1.7.60+). It does not render the frontend — only API actions.
