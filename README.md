...
**v1.8.5** — Inventory swipe-only + crumb threshold; recipe ingredients open Use  **v1.8.4** — Chat→Recipes pantry matching  **v1.8.3** — Hold-to-open list rows (scroll-friendly)  **v1.8.2** — Comprato fino a finito di nuovo; Rimuovi solo nel mese  **v1.8.1** — block mese  **v1.8.0** — Finished banners stick + carousel preserves position  **v1.7.99** — Short banner buttons + finished dismiss sticks  **v1.7.98** — Undo ledger ghost  **v1.7.97** — Gone products / crumb anomalies  **v1.7.96** — Estendi +7d  **v1.7.95** — Anti-waste shopping qty  **v1.7.94** — Hotfix kiosk/spesa  **v1.7.93** — Spesa mode UX + opened section  
